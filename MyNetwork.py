...
def train(train_txt,train_labels_txt,lr,k,num_epochs):
...
def test(text_txt,test_labels_txt,W,k):
    print('Loading images')
    X_test = []
    y_test = []
    num_cats = 10
...
if (func_to_call=='train'):
    ...
    train_labels_txt = sys.argv[3]
    lr = sys.argv[4]
    lr = float(lr)
    k = sys.argv[5]
    num_epochs = sys.argv[6]
    train(train_txt,train_labels_txt,lr,k,num_epochs)
elif(func_to_call=='test'):
    text_txt = sys.argv[2]
    test_labels_txt = sys.argv[3]
    W = sys.argv[4]
    k = sys.argv[5]
    test(text_txt,test_labels_txt,W,k)
